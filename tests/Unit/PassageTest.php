...
it('should create a passage with right parameters', function () {
    ...
    $newPassage2 = new Passage(
        $passageData2['passageNumber'],
        $passageData2['time'],
...
it(
    'should throw a negative passage exception for instantiate passages with bad parameters',
    function () {
...
it(
    'should throw a boundary passage exception for instantiate passages with bad parameters',
    function () {
...
it(
    'should throw a type error for instantiate a passage with bad types parameters',
    function () {
...
it(
    'should return a array of a passage object properties for the method "toArray()"',
    function () {
...
it(
    'should throw number exceptions when setting a passage number with a not conform integer',
    function () {
...
it(
    'should throw number exceptions when setting a passage time with a not conform float',
    function () {
