...
function createCategoryObject(array $categoryDataParameter = []): Category
{
    ...
    if (
        !empty($categoryDataParameter) === true &&
...
it(
    'should throw a empty exception for instantiate a category with empty strings parameter',
    function () {
...
it(
    'should throw a type error for instantiate a category with bad types parameters',
    function () {
...
it(
    'should return a array of a category object properties for the method "toArray()"',
    function () {
...
it(
    'should throws a empty string exception when setting a category string property',
    function () {
