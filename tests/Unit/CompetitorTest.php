...
function createCompetitorObject(array $eventDataParameter = []): Competitor
{
    ...
    if (
        !empty($competitorDataParameter) === true &&
        count(array_diff_key($competitorDataParameter, $competitorData)) === 0
    ) {
        $competitorData = $competitorDataParameter;
    }
    return new Competitor(
        $competitorData['name'],
        $competitorData['firstName'],
        $competitorData['raceNumber'],
        $competitorData['birthDate'],
        $competitorData['emailAddress'],
        $competitorData['photo'],
        $competitorData['identifier']
    );
}
...
it('should create a competitor with right parameters', function () {
    ...
    $newCompetitor1 = new Competitor(
        $competitorData1['name'],
        $competitorData1['firstName'],
        $competitorData1['raceNumber'],
        $competitorData1['birthDate'],
        $competitorData1['emailAddress'],
        $competitorData1['photo']
    );
    ...
    $newCompetitor2 = new Competitor(
        $competitorData2['name'],
        $competitorData2['firstName'],
        $competitorData2['raceNumber'],
        $competitorData2['birthDate'],
        $competitorData2['emailAddress'],
        $competitorData2['photo'],
        $competitorData2['identifier']
    );
    ...
    $newCompetitor3 = new Competitor(
        $competitorData3['name'],
        $competitorData3['firstName'],
        $competitorData3['raceNumber'],
        $competitorData3['birthDate'],
...
it(
    'should throw a empty exception for instantiate a competitor with empty strings parameters',
    function () {
...
it(
    'should throw a date exception for instantiate a competitor with bad date parameter',
    function () {
...
it(
    'should throw a negative number exception for instantiate a competitor with negative number parameter',
    function () {
...
it(
    'should throw a boundary number exception for instantiate a competitor with a bad number parameter',
    function () {
...
it(
    'should throw a email address symtax exception for instantiate a competitor with bad email parameter',
    function () {
...
it(
    'should throw a image extension exception for instantiate a competitor with bad image extension parameter',
    function () {
...
it(
    'should return a array of a competitor object properties for the method "toArray()"',
    function () {
...
it(
    'should throw a image extension exception for setting a property with bad image extension parameter',
    function () {
...
it(
    'should throw a email address symtax exception for setting a property with bad email parameter',
    function () {
...
it(
    'should throws number exceptions for setting a property with bad number parameter',
    function () {
...
it(
    'should throws boundary date exceptions for setting a property with bad date parameter',
    function () {
